...
export function Button(props: { title?: string, color?: "gray" | "teal" | "red" } & AriaButtonProps): JSX.Element {
  ...
  return (
    <button className={classNames('w-full border-2 border-black py-4 px-4 drop-shadow-lg active:drop-shadow-none flex items-center justify-center',
